...
<head>
    ...
    <link rel="stylesheet" href="<?php echo url('assets/css/custom.bootstrap.css'); ?>">
</head>
<body>
        ...
        <div class="col-md-6 bg-white p-5">
            ...
            <div class="form-style">
                <form>
                    ...
                    <div class="pb-2">
                        <button type="submit" class="btn w-100 font-weight-bold mt-2" style="background-color: #132f53; color: #fff">Đăng ký</button>
                    </div>
