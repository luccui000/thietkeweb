                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="form-group">
                                                ...
                                                <input value="<?php echo $result['ten_dia_diem']; ?>" name="ten_dia_diem" class="form-control must-translate" type="text" placeholder="Tên địa điểm" id="TenDiaDiem">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea value="<?php echo $result['mo_ta']; ?>" name="mo_ta" id="mo_ta" class="form-control must-translate" placeholder="Mô tả ngắn" ></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group position-relative">
                                                        ...
                                                        <textarea id="iframe" name="iframe" class="form-control" cols="30" rows="10">value="<?php echo $result['iframe']; ?>"</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?php echo $result['kinh_do']; ?>" name="kinh_do" id="kinh_do" class="form-control" >
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="vi_do">Vĩ độ</label>
                                                        <input value="<?php echo $result['vi_do']; ?>" name="vi_do" id="vi_do" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?php echo $result['dia_chi']; ?>" name="dia_chi" id="dia_chi" class="form-control" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
